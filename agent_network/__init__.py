...
# Install infrastructure adapters before callers import log_management.
from agent_network.file_management.log_integration import install_log_manager
from agent_network.log_management.log_batch_install import install_log_batch_manager
